...
#***************************************************
=begin
describe Bib::Periodico::ArticuloPeriodico do

	before :each do
		@Per1 = Bib::Periodico::ArticuloPeriodico.new(['David Chelimsky', 'Dave Astels', 'Bryan Helmkamp', 'Dan North', 'Zach Dennis', 'Aslak Hellesoy'], 'The RSpecBook', 'Behaviour Driven Development with RSpec', 'Pragmatic
Bookshelf', '1','(December 25, 2010)', ['ISBN-10: 1934356379.' ,'ISBN-13: 978-1934356371'])
